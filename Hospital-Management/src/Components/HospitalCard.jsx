...
import { data } from './HospitalData'; // Import the data array
...
function Card({ id, title, open, close }) {
  return (
    <Link to="/home" className="card bg-slate-200 w-80 min-w-56 h-auto overflow-hidden rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-[1px] hover:cursor-pointer" key={id}>
